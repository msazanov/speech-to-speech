...
- Не считай именем обычную конструкцию «я» + глагол или длинную фразу, например «я говорю, что это не смешно».
...
- Подтверждение или отклонение личности допустимо только при явном ответе пользователя «да/это я» или «нет/это не я» в текущей реплике; не трактуй как решение другие вопросы и фразы.
