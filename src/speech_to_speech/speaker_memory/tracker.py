...
class SpeakerMemoryService:
    """Tool-facing semantic operations with server-owned evidence weights."""
    ...
    def inspect(self, speaker_ref: str, *, conversation_id: str) -> SpeakerAttribution:
        ...
        candidates = self.store.resolve_person_candidates(reference.voice_id)
        ...
        if candidate is None:
            ...
            state = SpeakerState.KNOWN if decisive else SpeakerState.CONFLICT
        return SpeakerAttribution(
