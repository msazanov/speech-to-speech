    ...
    *,
    ...
    try:
        ...
        tracker = SpeakerTracker(
            ...
            soft_match_weight=arguments.speaker_memory_soft_match_weight,
            automerge_threshold=arguments.speaker_memory_automerge_threshold,
            automerge_min_samples=arguments.speaker_memory_automerge_min_samples,
...
def build_local_pipeline(args: ParsedArguments, stop_event: Event) -> ThreadManager:
    ...
    client = RealtimeAudioClient(
        ...
        RealtimeAudioClientConfig(
            ...
            echo_cancel=local_audio.local_audio_echo_cancel,
            echo_cancel_frame_ms=local_audio.local_audio_echo_cancel_frame_ms,
            echo_cancel_filter_ms=local_audio.local_audio_echo_cancel_filter_ms,
            tools=tools,
